...
const CustomDatePickerForm = ({
  ...
  // Debug
  //console.log("Debug customDatePickerForm: ", months);
        ...
        return (
          <div className={`${divClass} mb-4 xl:w-96`}>
            ...
            {label && (
              <label
                htmlFor={name}
                className="form-label inline-block text-sm text-gray-700 font-bold mb-1"
              >
                {label}
              </label>
            )}
            ...
            <DatePicker
              ...
              onChange={(val) => {
                ...
                //console.log("Debug datePicker: ", typeof val);
              }}
